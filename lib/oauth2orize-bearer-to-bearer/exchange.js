 ...
 *
 * This exchange middleware is used by clients to request an access token by
 ...
 * Any additional `params` will be included in the response. If an error occurs,
 * `done` should be invoked with `err` set in idiomatic Node.js fashion.
 *
 * Options:
 *
...
module.exports = (issue, options = {}) => {
  if (!issue) throw new Error('OAuth 2.0 bearer exchange middleware requires an issue function.');
